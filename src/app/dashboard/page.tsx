        ...
        <div className="fixed inset-0 z-[9999] bg-[#001232]/70 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-white rounded-3xl p-8 sm:p-10 max-w-md w-full relative shadow-2xl animate-fade-in-down text-center border border-gray-100">
            ...
            <p className="text-gray-500 text-[15px] leading-relaxed mb-8">
              Access your memorization progress, daily marks, and examination results from your dashboard.
            </p>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            <div className="flex items-center space-x-3">
              <div className="w-10 h-10 bg-white rounded-xl shadow-sm border border-gray-100 flex items-center justify-center p-1.5 shrink-0">
                      ...
                      <div className="px-2 max-h-48 overflow-y-auto custom-scrollbar">
                        {userData.enrollments.map((enr) => (
                          <button 
                            ...
                            className={`w-full text-left flex items-start px-3 py-2.5 rounded-xl text-sm font-semibold transition-all mb-1 ${activeEnrollment?.id === enr.id ? 'bg-[#001232] text-[#FFB902]' : 'text-gray-600 hover:bg-gray-50 hover:text-[#001232]'}`}
                          >
                            <BookOpen className={`w-4 h-4 mr-3 shrink-0 mt-0.5 ${activeEnrollment?.id === enr.id ? 'text-[#FFB902]' : 'text-gray-400'}`} />
                            <span dir="auto" className="whitespace-normal leading-snug">{enr.program.titleEn}</span>
                          </button>
                        ))}
                      </div>
          ...
          <div className="flex flex-col min-w-0">
            ...
            <div className="mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div className="min-w-0">
                {/* Removed truncate and added dir="auto" for natural Arabic support */}
                ...
                <p className="text-gray-500 mt-1 text-[14px] font-medium">Student Dashboard</p>
              </div>
            ...
            {activeEnrollment.approvalStatus === "PENDING" ? (
              ...
              /* Compact, Bold Premium Grid */
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
                
                {/* 1. Daily Marks Card (Rich Brand Colors, Deep Gradient) */}
                <div 
                  onClick={() => router.push(`/dashboard/${activeEnrollment.id}/marks`)}
                  className="group relative overflow-hidden rounded-[1.5rem] p-5 sm:p-6 cursor-pointer transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl bg-gradient-to-br from-[#001232] to-[#001b45] border border-[#001232] flex flex-col h-full"
                >
                  <div className="absolute top-0 right-0 w-32 h-32 bg-[#FFB902] opacity-10 rounded-full blur-2xl transform translate-x-1/2 -translate-y-1/4 pointer-events-none"></div>
                  ...
                  <h3 className="text-xl font-extrabold text-white mb-2 relative z-10">Daily Marks</h3>
                  ...
                  <div className="mt-5 flex items-center text-[#FFB902] font-bold text-[14px] relative z-10">
                    View Progress <ArrowRight className="w-4 h-4 ml-2 group-hover:translate-x-2 transition-transform duration-300" />
                  </div>
                </div>
                ...
                <div 
                  ...
                  className="group relative overflow-hidden rounded-[1.5rem] p-5 sm:p-6 cursor-not-allowed bg-white border border-gray-200 transition-all hover:border-gray-300 hover:shadow-md flex flex-col h-full"
                >
                  ...
                  <h3 className="text-xl font-extrabold text-gray-400 mb-2">Examinations</h3>
                ...
                >
                  ...
                  <h3 className="text-xl font-extrabold text-gray-400 mb-2">Final Result</h3>
                  <p className="text-gray-400 text-[14px] leading-relaxed flex-grow">
