...
interface Option {
  label: string;
  value: string;
  prefix?: string; // For flags or dial codes
}
  ...
  return (
    <div className="relative w-full" ref={dropdownRef}>
      ...
      <button
        ...
        className={`w-full px-4 py-3 border rounded-lg outline-none transition-all flex justify-between items-center bg-white ${
          ...
          {searchable && (
            <div className="p-2 border-b border-gray-100 bg-gray-50">
              <div className="relative">
                ...
                <input
                  type="text"
                  className="w-full pl-9 pr-4 py-2 text-sm border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-[#FFB902] focus:border-[#FFB902] text-[#001232]"
                  placeholder="Search..."
                  value={searchTerm}
