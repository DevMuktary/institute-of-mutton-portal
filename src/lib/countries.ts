export const countries = [
  ...
  { name: "Congo (Congo-Brazzaville)", code: "CG", flag: "🇨🇬", dialCode: "+242" },
  ...
  { name: "Czechia", code: "CZ", flag: "🇨🇿", dialCode: "+420" },
  { name: "Democratic Republic of the Congo", code: "CD", flag: "🇨🇩", dialCode: "+243" },
  ...
  { name: "Myanmar (Burma)", code: "MM", flag: "🇲🇲", dialCode: "+95" },
